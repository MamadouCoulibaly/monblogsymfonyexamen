 ...
 */
class Post extends \MainBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'subtitle', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'code', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'author', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'post', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'image', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'createdAt', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'category', '' . "\0" . 'MainBundle\\Entity\\Post' . "\0" . 'comment'];
        }
